...
class FabricPlugin implements Plugin<Project> {
        ...
        proj.with {
            ...
            dependencies.with {
                ...
                if (Conventions.hasObfuscation(proj)) {
                    ...
                    modApi "net.fabricmc.fabric-api:fabric-api:${proj.fabric_api_version}"
                } else {
                    implementation "net.fabricmc:fabric-loader:${fabric_loader_version}"
                    api "net.fabricmc.fabric-api:fabric-api:${proj.fabric_api_version}"
                }
            ...
            if (hasCurseforge) {
                curseforge {
                    ...
                    it.project {
                        id = "${propertyWithFallback(proj, "curseforge_id", "curseforge_id_fabric")}"
                        ...
                        var dependencies = proj.curseforge_dep_fabric
                        if (!"${dependencies}".isEmpty() || proj.hasProperty("optional_curseforge_dep_fabric")) {
                            relations {
                                ...
                                if (proj.hasProperty("optional_curseforge_dep_fabric")) {
            ...
            if (hasModrinth) {
                modrinth {
                    ...
                    dependencies {
                        ...
                        if (proj.hasProperty("optional_modrinth_dep_fabric")) {
